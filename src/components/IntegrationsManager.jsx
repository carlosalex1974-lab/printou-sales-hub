                ...
                <div className="glass-panel p-6 rounded-2xl border border-white/5 space-y-4">
                    ...
                    <div className="space-y-3 text-xs">
                        ...
                        <div className="border-t border-white/5 pt-3">
                            <span className="text-[10px] text-brand-yellow font-extrabold uppercase tracking-widest block mb-2">Conta 1: printoustudio3d (Clássico)</span>
                        ...
                        <div className="border-t border-white/5 pt-3">
                            <span className="text-[10px] text-brand-yellow font-extrabold uppercase tracking-widest block mb-2">Conta 2: AlucarPrintoustudio3d (Premium)</span>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1">
                                    <span className="text-gray-400 font-bold uppercase text-[9px] block">Client ID</span>
                                    <input
