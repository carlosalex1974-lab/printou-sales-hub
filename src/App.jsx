        ...
        return parseFloat((rawCost + prod.finishingCost + prod.packagingCost).toFixed(2));
            ...
            const computeSaleFinancials = (sale) => {
                ...
                if (sale.channelId === 'direta') {
                    // Venda Direta / Pix: Usa estritamente o valor da venda (padrão R$ 0,00)
                    ...
                    // Se o frete da venda for maior que 0, usa ele; se for 0/omisso (frete grátis ao comprador), aplica o frete do vendedor (produto ou canal)
                    if (sale.shipping !== undefined && sale.shipping !== null && sale.shipping !== '' && !isNaN(parseFloat(sale.shipping)) && parseFloat(sale.shipping) > 0) {
                        shipping = parseFloat(sale.shipping);
                    } else if (prod && prod.customShippingCost !== undefined && prod.customShippingCost !== null && parseFloat(prod.customShippingCost) > 0) {
